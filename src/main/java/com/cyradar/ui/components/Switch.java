 ...
 * @author mouse
 */
public class Switch extends AbstractButton implements MouseListener {
    ...
    public Switch() {
        super();
        Switch.this.setSize(new Dimension(50, 30));
        Switch.this.setPreferredSize(new Dimension(50, 30));
        Switch.this.setMinimumSize(new Dimension(50, 30));
